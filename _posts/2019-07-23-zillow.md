...
```python
q1_a_vis = q1_a.sort_values("ton",ascending=False).head(20)
q1_a_vis[["ZHVI_MiddleTier","City","County","State"]]
```
    ...
    <ipython-input-48-5ed476f166d5> in <module>
    ----> 1 q1_a_vis = q1_a.sort_values("ton",ascending=False).head(20)
          2 q1_a_vis[["ZHVI_MiddleTier","City","County","State"]]
    ...
    /anaconda3/lib/python3.6/site-packages/pandas/core/generic.py in _get_label_or_level_values(self, key, axis)
       1705             values = self.axes[axis].get_level_values(key)._values
       1706         else:
    -> 1707             raise KeyError(key)
       1708
...
```
    ...
    <ipython-input-49-2659109d2f11> in <module>
    ----> 1 q1_a_plot = sns.barplot(x="graph", y="ZHVI_MiddleTier", data=q1_a_vis)
          2 q1_a_plot.set_xticklabels(q1_a_plot.get_xticklabels(), rotation=90,size=7)


    NameError: name 'q1_a_vis' is not defined
...
```
    ...
    <ipython-input-57-f4012031dc72> in <module>
          1 #### min_graph = sns.barplot(x="State", y="ZHVIPerSqft_AllHomes", data=q2_a[q2_min])
    ----> 2 min_graph.set_xticklabels(min_graph.get_xticklabels(), rotation=90,size=7)


    NameError: name 'min_graph' is not defined
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1a5e05ecf8>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1a5dbc7f28>
...
Something peculiar is happening here.  Many of these cities have similar names or seem to be duplicates that are indexed seperately.  I'm not sure what Zillow's reasoning is behind this move.
...
Many of these cities are similar to the losts above which makes sense considering the time series in question.
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1a5e039390>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1a4232d358>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1a5e039080>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>529</th>
      <td>mccandless_townshipalleghenypa</td>
      <td>2017</td>
      <td>135.0</td>
      <td>2015</td>
      <td>123.0</td>
    ...
    <tr>
      <th>579</th>
      <td>mount_pleasantcharlestonsc</td>
      <td>2017</td>
      <td>205.0</td>
      <td>2015</td>
      <td>186.0</td>
    ...
    <tr>
      <th>722</th>
      <td>port_charlottecharlottefl</td>
      <td>2017</td>
      <td>112.0</td>
      <td>2015</td>
      <td>87.0</td>
    ...
    <tr>
      <th>781</th>
      <td>saint_augustinesaint_johnsfl</td>
      <td>2017</td>
      <td>129.0</td>
      <td>2015</td>
      <td>113.0</td>
    ...
    <tr>
      <th>746</th>
      <td>rancho_cucamongasan_bernardinoca</td>
      <td>2017</td>
      <td>276.0</td>
      <td>2015</td>
      <td>247.0</td>
    ...
    <tr>
      <th>607</th>
      <td>newport_newsnewport_news_cityva</td>
      <td>2017</td>
      <td>114.0</td>
      <td>2015</td>
      <td>109.0</td>
    ...
    <tr>
      <th>433</th>
      <td>king_of_prussiamontgomerypa</td>
      <td>2017</td>
      <td>167.0</td>
      <td>2015</td>
      <td>157.0</td>
    ...
    <tr>
      <th>926</th>
      <td>town_of_hamptonrockinghamnh</td>
      <td>2017</td>
      <td>229.0</td>
      <td>2015</td>
      <td>201.0</td>
    ...
    <tr>
      <th>134</th>
      <td>burrillvilleprovidenceri</td>
      <td>2017</td>
      <td>172.0</td>
      <td>2015</td>
      <td>150.0</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>211</th>
      <td>culver_citylos_angelesca</td>
      <td>2017</td>
      <td>640.0</td>
      <td>2015</td>
      <td>504.0</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>856</th>
      <td>south_pasadenalos_angelesca</td>
      <td>2017</td>
      <td>670.0</td>
      <td>2015</td>
      <td>570.0</td>
